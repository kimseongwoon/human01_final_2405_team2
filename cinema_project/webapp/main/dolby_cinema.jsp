...
<div class="theater-specail-cont">  
  <div class="inner-wrap pt40">
    <div class="tab-list fixed mb40 on">
	  <ul id="tab-list">
		<li class="on">
		  <a href="/specialtheater/dolby" data-target="sectionInfo" title="DOLBY CINEMA 소개 탭으로 이동">DOLBY CINEMA 소개</a>
		 </li>
		 <li>
		   <a href="/specialtheater/dolby/time" data-target="sectionInfo" title="상영시간표 탭으로 이동">상영시간표</a>
		  </li>
		 </ul>
		</div>
	   </div>
	   <!-- section -->
 <div class="section sectionlnfo">
   <!-- bg-wrap -->
   <div class="bg-wrap">
      ...
      <div class="inner-wrap">
        <div class="cont-theater pt00">
          <div class="col-group col-3">    
		    ...
		    <div class="col">
			  <p class="img">
			    <img src="https://img.megabox.co.kr/static/pc/images/theater/img-theater-db-view03.png" alt>
			  </p>
			  <p class="bottom-txt">
            ...
            <div class="col">
			  <p class="img">  
				<img src="https://img.megabox.co.kr/static/pc/images/theater/img-theater-db-view04.png" alt>
			  </p>
			  <p class="bottom-txt">
